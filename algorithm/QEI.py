...
class QEI(GPOptimizer):
    ...
    def generate_initial_data(self): ## need to change this n later
        ...
        train_x = self.x
        exact_obj = self.utils
        exact_con = self.safes
    ...
    def optimize_acqf_and_get_observation(self, acq_func):
        ...
        candidates, _ = optimize_acqf(
            ...
            raw_samples=self.x.shape[0],  # not sure if this is correct, check
        ...
        if self.batch_size > 1:
            ...
            for i in range(self.batch_size):
                ...
                # print(eval_input.shape, type(eval_input), eval_input[0], new_x.shape)
